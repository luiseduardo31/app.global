                  ...
                  @method('PUT')
                    <div class="form-group form-row"> 
                        ...
                        <div class="col-2">
                            ...
                            <input type="text" name="custo_plano" class="form-control money" placeholder="Ex.: R$ 44,90" value="{{$planos->custo_plano}}"" maxlength="50">
                        </div>
                        ...
                        <div class="col-3">
                            ...
                            @foreach ($operadoras as $operadora)
                                <option value="{{$operadora->id}}" {{ ( $operadora->id == $planos->operadora_id) ? 'selected' : '' }}>
                                    {{$operadora->operadora}}
                                </option>
                            @endforeach
                            </select>
