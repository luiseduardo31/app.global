                ...
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <a class="link-fx" href="">Cadastrar Novo Grupo</a>
                        </li>
                    </ol>
                </nav>
            </div>
                  ...
                  @csrf
                    <div class="form-group form-row">
                        <div class="col-4">
                            ...
                            <input type="text" name="grupo" class="form-control" placeholder="Grupo Empresarial" maxlength="50">
                        </div>
                    </div>
                    <div class="form-group form-row">
                        <div class="col-12">
                    ...
                    <div class="form-group form-row">
                        ...
                        <div class="col-2">
                            <a href="{{route('grupos.index')}}" class="btn btn-danger form-control"  onclick="return confirm('Deseja realmente cancelar o cadastro?')">
                                Cancelar
                            </a>
                        </div>
                    </div>
