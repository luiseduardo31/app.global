...
CREATE TABLE IF NOT EXISTS `inventarios` (
  ...
  `tipos_linhas_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `fk_inventarios_tipos_linhas1_idx` (`tipos_linhas_id`),
...
INSERT INTO `inventarios` (`id`, `linha`, `nome_usuario`, `data_registro`, `matricula`, `funcao`, `chip`, `observacao`, `conta_id`, `setor_id`, `subsetor_id`, `gestor_id`, `plano_id`, `status_id`, `tipos_linhas_id`) VALUES
	(3, '27988554488', 'Luis Eduardo', '2020-02-20', 'ES 548032020', 'Gerencia', '88889999111155553333', 'Teste Observação', 1, 1, 1, 1, 1, 1, 1);
...
INSERT INTO `tipos_linhas` (`id`, `tipos`) VALUES
	(4, 'Dados'),
	(1, 'Voz'),
	(3, 'Voz + Dado');
...
INSERT INTO `ultimos_usuarios` (`id`, `ultimo_usuario`, `linha`, `data_inicio`, `data_termino`, `data_alteracao`) VALUES
	(3, 'Luis Eduardo', '27988554488', '2020-02-20', NULL, '2020-02-25 20:23:44');
